...
class TestBasicSynthesis:
    ...
    def test_single_supporting_evidence(self) -> None:
        ...
        service.record_relation("ev-1", "ev-2", RelationType.SUPPORTS, "Same claim.")
    ...
    def test_multiple_supporting_evidence(self) -> None:
        ...
        synthesizer = EvidenceSynthesizer(service)
        finding = synthesizer.synthesize(["ev-1", "ev-2", "ev-3"], "Claim X.")
...
class TestContradictionHandling:
    ...
    def test_support_plus_contradiction_is_contested(self) -> None:
        ...
        synthesizer = EvidenceSynthesizer(service)
        finding = synthesizer.synthesize(["ev-a", "ev-b", "ev-c"], "X date.")
    ...
    def test_conflict_not_resolved(self) -> None:
        ...
        service.record_relation("ev-1", "ev-2", RelationType.CONTRADICTS, "Different dates.")

        synthesizer = EvidenceSynthesizer(service)
        finding = synthesizer.synthesize(["ev-1", "ev-2"], "When did X occur?")
    ...
    def test_multiple_contradictions(self) -> None:
        ...
        synthesizer = EvidenceSynthesizer(service)
        finding = synthesizer.synthesize(["ev-1", "ev-2", "ev-3"], "Is A true?")
...
class TestRelationTypes:
    ...
    def test_supports_relation(self) -> None:
        ...
        finding = EvidenceSynthesizer(service).synthesize(["ev-1", "ev-2"], "A.")
        assert finding.status == FindingState.SUPPORTED
    ...
    def test_corroborates_relation(self) -> None:
        service = _setup_service_with_evidence(
            [
                ("ev-1", "B."),
                ("ev-2", "B independently."),
            ]
        )
        service.record_relation("ev-1", "ev-2", RelationType.CORROBORATES)

        finding = EvidenceSynthesizer(service).synthesize(["ev-1", "ev-2"], "B.")
        assert finding.status == FindingState.SUPPORTED
    ...
    def test_contradicts_relation(self) -> None:
        ...
        finding = EvidenceSynthesizer(service).synthesize(["ev-1", "ev-2"], "C.")
        assert finding.status == FindingState.CONTESTED
    ...
    def test_derived_from_does_not_affect_status(self) -> None:
        ...
        finding = EvidenceSynthesizer(service).synthesize(["ev-1", "ev-2"], "Original.")
...
class TestProvenance:
    ...
    def test_evidence_basis_contains_all_input_ids(self) -> None:
        ...
        finding = EvidenceSynthesizer(service).synthesize(["ev-1", "ev-2", "ev-3"], "Topic.")
    ...
    def test_evidence_basis_is_sorted(self) -> None:
        ...
        finding = EvidenceSynthesizer(service).synthesize(["ev-c", "ev-a", "ev-b"], "Topic.")
    ...
    def test_finding_traces_to_s24_evidence(self) -> None:
        ...
        finding = EvidenceSynthesizer(service).synthesize(["ev-1"], "Traceable claim.")
    ...
    def test_finding_traces_to_s23_provenance(self) -> None:
        ...
        finding = EvidenceSynthesizer(service).synthesize(["ev-1"], "Full trace.")
...
class TestDeterminism:
    ...
    def test_duplicate_ids_deduplicated(self) -> None:
        ...
        finding = synthesizer.synthesize(["ev-1", "ev-1", "ev-1"], "X.")
...
class TestS23ToS25Integration:
    ...
    def test_full_pipeline_acquire_to_finding(self) -> None:
        ...
        req1 = ExternalInformationRequest(query="NAV version", request_id="s25-req-001")
        result1 = self.capability.acquire(req1)
        assert result1.is_success

        req2 = ExternalInformationRequest(query="NAV version info", request_id="s25-req-002")
    ...
    def test_contested_finding_from_pipeline(self) -> None:
        ...
        finding = self.synthesizer.synthesize(["ev-date-a", "ev-date-b"], "When did X occur?")
...
class TestS24BehaviorPreserved:
    ...
    def test_s24_relations_still_work(self) -> None:
        ...
        rel = service.record_relation("ev-r1", "ev-r2", RelationType.SUPPORTS)
...
class TestS23BehaviorPreserved:
    ...
    def test_s23_honesty_invariant_still_works(self) -> None:
        result = ExternalInformationResult(
            ...
            items=[ExternalInformationItem(content="Ghost.", source=_make_source())],
            provider_id="test",
        )
